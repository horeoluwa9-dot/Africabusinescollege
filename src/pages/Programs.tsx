      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        >
          <div className="aspect-[4/3] rounded-3xl overflow-hidden border border-slate-100 shadow-2xl">
            <img 
              src="https://picsum.photos/seed/campus/1200/900" 
              alt="Campus" 
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        <div className="lg:col-span-8 bg-white rounded-3xl border border-slate-100 overflow-hidden flex flex-col md:flex-row group cursor-pointer hover:shadow-2xl transition-all">
          ...
          <div className="md:w-1/2 relative overflow-hidden">
            <img 
              src="https://picsum.photos/seed/innovation/800/800?grayscale" 
              alt="Innovation" 
        ...
        <div className="grid grid-cols-2 gap-4 relative">
          <div className="space-y-4">
            <div className="aspect-square rounded-2xl overflow-hidden shadow-xl">
              <img src="https://picsum.photos/seed/eco1/600/600" alt="Eco" className="w-full h-full object-cover" referrerPolicy="no-referrer" />
            </div>
            <div className="aspect-[4/3] rounded-2xl overflow-hidden shadow-xl">
              <img src="https://picsum.photos/seed/eco2/600/450" alt="Eco" className="w-full h-full object-cover" referrerPolicy="no-referrer" />
            </div>
          </div>
          <div className="space-y-4 pt-12">
            <div className="aspect-[3/4] rounded-2xl overflow-hidden shadow-xl">
              <img src="https://picsum.photos/seed/eco3/450/600" alt="Eco" className="w-full h-full object-cover" referrerPolicy="no-referrer" />
            </div>
            <div className="aspect-square rounded-2xl overflow-hidden shadow-xl">
              <img src="https://picsum.photos/seed/eco4/600/600" alt="Eco" className="w-full h-full object-cover" referrerPolicy="no-referrer" />
            </div>
          </div>
